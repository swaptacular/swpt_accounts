...
Revision ID: 494204926e62
Revises: 
Create Date: 2019-05-04 22:30:42.879453
...
def upgrade():
    ...
    sa.Column('demurrage_rate', sa.REAL(), nullable=False),
    sa.Column('demurrage_rate_ceiling', sa.REAL(), nullable=False),
    sa.Column('last_change_seqnum', sa.BigInteger(), nullable=False, comment='This is incremented on every change. Zero indicates a deactivated debtor.'),
