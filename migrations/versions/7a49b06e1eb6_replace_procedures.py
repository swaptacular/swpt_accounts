...
Revision ID: 7a49b06e1eb6
Revises: c515d6cbd8c6
Create Date: 2024-08-13 19:51:53.326014
...
revision = '7a49b06e1eb6'
down_revision = 'c515d6cbd8c6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.replace_sp(calc_current_balance_sp, replaces="c515d6cbd8c6.calc_current_balance_sp")
    op.replace_sp(lock_account_sp, replaces="c515d6cbd8c6.lock_account_sp")
    op.replace_sp(insert_account_update_signal_sp, replaces="c515d6cbd8c6.insert_account_update_signal_sp")
    op.replace_sp(lock_or_create_account_sp, replaces="c515d6cbd8c6.lock_or_create_account_sp")
    op.replace_sp(get_min_account_balance_sp, replaces="c515d6cbd8c6.get_min_account_balance_sp")
    op.replace_sp(reject_transfer_sp, replaces="c515d6cbd8c6.reject_transfer_sp")
    op.replace_sp(prepare_transfer_sp, replaces="c515d6cbd8c6.prepare_transfer_sp")
    op.replace_sp(process_transfer_requests_sp, replaces="c515d6cbd8c6.process_transfer_requests_sp")
    op.replace_sp(apply_account_change_sp, replaces="c515d6cbd8c6.apply_account_change_sp")
    op.replace_sp(calc_status_code_sp, replaces="c515d6cbd8c6.calc_status_code_sp")
    op.replace_sp(process_finalization_requests_sp, replaces="c515d6cbd8c6.process_finalization_requests_sp")
    op.replace_sp(insert_account_transfer_signal_sp, replaces="c515d6cbd8c6.insert_account_transfer_signal_sp")
    op.replace_sp(process_pending_balance_changes_sp, replaces="c515d6cbd8c6.process_pending_balance_changes_sp")
    op.replace_sp(calc_due_interest_sp, replaces="c515d6cbd8c6.calc_due_interest_sp")


def downgrade():
    op.replace_sp(calc_due_interest_sp, replace_with="c515d6cbd8c6.calc_due_interest_sp")
    op.replace_sp(process_pending_balance_changes_sp, replace_with="c515d6cbd8c6.process_pending_balance_changes_sp")
    op.replace_sp(insert_account_transfer_signal_sp, replace_with="c515d6cbd8c6.insert_account_transfer_signal_sp")
    op.replace_sp(process_finalization_requests_sp, replace_with="c515d6cbd8c6.process_finalization_requests_sp")
    op.replace_sp(calc_status_code_sp, replace_with="c515d6cbd8c6.calc_status_code_sp")
    op.replace_sp(apply_account_change_sp, replace_with="c515d6cbd8c6.apply_account_change_sp")
    op.replace_sp(process_transfer_requests_sp, replace_with="c515d6cbd8c6.process_transfer_requests_sp")
    op.replace_sp(prepare_transfer_sp, replace_with="c515d6cbd8c6.prepare_transfer_sp")
    op.replace_sp(reject_transfer_sp, replace_with="c515d6cbd8c6.reject_transfer_sp")
    op.replace_sp(get_min_account_balance_sp, replace_with="c515d6cbd8c6.get_min_account_balance_sp")
    op.replace_sp(lock_or_create_account_sp, replace_with="c515d6cbd8c6.lock_or_create_account_sp")
    op.replace_sp(insert_account_update_signal_sp, replace_with="c515d6cbd8c6.insert_account_update_signal_sp")
    op.replace_sp(lock_account_sp, replace_with="c515d6cbd8c6.lock_account_sp")
    op.replace_sp(calc_current_balance_sp, replace_with="c515d6cbd8c6.calc_current_balance_sp")
