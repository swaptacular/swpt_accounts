...
Revision ID: b172d035f376
Revises: 
Create Date: 2019-06-11 20:23:42.676948
...
def upgrade():
    ...
    op.create_table('scheduled_account_principal_change',
    sa.Column('debtor_id', sa.BigInteger(), nullable=False),
    sa.Column('creditor_id', sa.BigInteger(), nullable=False),
    sa.Column('principal_delta', sa.BigInteger(), nullable=False),
    sa.Column('is_interest_payment', sa.BOOLEAN(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('scheduled_account_principal_change')
