...
class Configuration(metaclass=MetaEnvReader):
    ...
    APP_FLUSH_REJECTED_TRANSFERS_BURST_COUNT = 7500
    APP_FLUSH_PREPARED_TRANSFERS_BURST_COUNT = 7500
    APP_FLUSH_FINALIZED_TRANSFERS_BURST_COUNT = 7500
    APP_FLUSH_ACCOUNT_TRANSFERS_BURST_COUNT = 7500
    APP_FLUSH_ACCOUNT_UPDATES_BURST_COUNT = 7500
    APP_FLUSH_ACCOUNT_PURGES_BURST_COUNT = 7500
    APP_FLUSH_REJECTED_CONFIGS_BURST_COUNT = 7500
    APP_FLUSH_PENDING_BALANCE_CHANGES_BURST_COUNT = 7500
    ...
    APP_REGISTERED_BALANCE_CHANGES_SCAN_BLOCKS_PER_QUERY = 30
