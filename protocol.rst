...
.. [#demurrage] Note that when the interest rate on a given account is
  ...
  commit of the prepared transfer will not be successful. This is a
  necessary precaution in order to prevent a trick that opportunistic
  creditors may use to evade incurring negative interest on their
