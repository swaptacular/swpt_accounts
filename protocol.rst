...
.. [#account-identity] An empty string MUST indicate that the account
  have not got an identity yet. Once the account have got an identity,
  it MUST not be changed until the account is deleted.
